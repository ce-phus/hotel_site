  ...
  return (
    <section id="contact" className="relative bg-hero-bg mx-auto">
      <div className={`max-w-7xl mx-auto ${styles.paddingX}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pl-10 md:pl-10 bg-secondary border border-transparent mt-10">
            ...
            <form className="max-w-lg mt-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="mb-6">
                  ...
                  <input className="appearance-none block w-full bg-primary text-white border border-[#808080] mb-3 py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane" />
                </div>
                <div className="mb-6">
